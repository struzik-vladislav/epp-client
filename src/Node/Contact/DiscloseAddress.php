...
/**
 * Object representation of the <contact:addr> node for disclosing information.
 */
class DiscloseAddress extends AbstractNode
{
    const TYPE_LOC = 'loc';
    const TYPE_INT = 'int';
    ...
    {
        parent::__construct($request, 'contact:addr', $parameters);
    }
