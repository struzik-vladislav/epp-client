...
/**
 * Object representation of the request of the contact transferring with operation 'approve'.
 */
class TransferApprove extends AbstractRequest
{
    /**
     * @var string
     */
    ...
    protected function handleParameters()
    {
        ...
        $transfer = new TransferNode($this, ['operation' => TransferNode::OPERATION_APPROVE]);
