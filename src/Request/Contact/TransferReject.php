...
/**
 * Object representation of the request of the contact transferring with operation 'reject'.
 */
class TransferReject extends AbstractRequest
{
    /**
     * @var string
     */
    ...
    protected function handleParameters()
    {
        ...
        $transfer = new TransferNode($this, ['operation' => TransferNode::OPERATION_REJECT]);
